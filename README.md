...
<<<<<<< HEAD
    ...
    └── Xilinx_Unified_2020.1_1118_1232_Lin64.bin
=======
    ├── petalinux-v2020.1-*-installer.run
    └── Xilinx_Unified_2020.1_*_Lin64.bin
>>>>>>> main
...
```
$ cd ./docker
$ docker-compose -f ./docker-compose.yml run --rm peta-vivado-2020.1 /bin/bash
docker$  vivado &
    ...
```
